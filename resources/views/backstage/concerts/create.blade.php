                            ...
                            <div class="row">
                                <div class="col col-md-6">
                                    <div class="form-group {{ $errors->first('ticket_price', 'has-error') }}">
                                        ...
                                        <span class="input-group-addon text-dark-muted">$</span>
            ...
            <div class="row">
                <div class="col col-lg-4">
                    <div class="p-xs-y-4">
                        ...
                        <p class="text-dark-soft text-sm">Have a sweet poster for this concert? Upload it here and it'll be included on the checkout page.</p>
                    </div>
                </div>
                <div class="col col-lg-8">
                    <div class="card">
