...
<div class="row m-xs-b-5">
    <div class="col col-md-6 col-md-offset-1 m-xs-b-4 m-lg-b-0">
        <div class="card flex">
            <div class="row flex-fit">
                <div class="col col-lg-6 hidden-md-down p-xs-0 p-xs-1-4">
                    <div class="card-section">
                        <img src="{{ $concert->posterUrl() }}" class="img-fit">
                    </div>
                </div>
            </div>
            ...
            <div class="col col-xs-12 col-lg-6">
                ...
                <div class="border-t">
                    <div class="card-section">
                        <ticket-checkout :concert-id="{{ $concert->id }}" concert-title="{{ $concert->title }}" :price="{{ $concert->ticket_price }}"></ticket-checkout>
                    </div>
                </div>
            </div>
        </div>
