...
class SendAttendeeMessage implements ShouldQueue
{
    ...
    {
        // Image we have 2000 email addresses, then we are looping over 2000 HTTP requests
        ...
        // for example, 7 of 2000 failed, we will get the 7 failed ones in the table somewhere and
        // we can retry these ones easily.
